package com.jayghz.bookhub.integration.payment.paypal.service;
...
public class PayPalService {
    // Recuperar los valores de las propiedades de la aplicación desde el archivo application.properties
    ...
    // Inyectar el Repositorio de Compras
    @NonNull
    ...
    public String getAccessToken() {
        ...
        // Realización de Solicitudes:enviando una solicitud POST a la API de PayPal
