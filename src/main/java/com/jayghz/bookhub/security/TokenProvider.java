...
import com.jayghz.bookhub.exception.RoleNotFoundException;
...
@Component
public class TokenProvider { // Clase para generar y validar tokens JWT
    ...
    public String createAccessToken(Authentication authentication) {
        ...
        return Jwts
                .builder()
                .setSubject(email)  // El sujeto será el email o el nombre de usuario
