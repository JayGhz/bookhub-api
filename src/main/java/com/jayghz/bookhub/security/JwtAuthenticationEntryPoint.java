...
import com.jayghz.bookhub.exception.CustomErrorResponse;
...
@Component
public class JwtAuthenticationEntryPoint implements AuthenticationEntryPoint { // Clase para manejar errores de autenticación
