...
public class JwtFilter extends GenericFilterBean { // Clase para extraer información del token JWT
    ...
    public void doFilter(ServletRequest request,
        ...
        if (StringUtils.hasText(bearerToken) && bearerToken.startsWith("Bearer ")) {
            String token = bearerToken.substring(7); // Extraer el token sin el prefijo "Bearer "
